...
A production-ready PostgreSQL Docker image based on Ubuntu Noble (24.04) with PostgreSQL 17.5.
...
docker run -d \
  ...
  -p 5432:5432 \
  ghcr.io/andrielson/postgres:17-noble
...
```bash
docker build -t postgres:17-noble .
```
