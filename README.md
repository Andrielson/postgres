...
A production-ready PostgreSQL Docker image based on Ubuntu Noble (24.04) with PostgreSQL 15.13.
...
docker run -d \
  ...
  -p 5432:5432 \
  ghcr.io/andrielson/postgres:15-noble
...
```bash
docker build -t postgres:15-noble .
```
